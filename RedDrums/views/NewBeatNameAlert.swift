...
struct NewBeatNameAlert: View {
    ...
    var body: some View {
        GeometryReader { geo in
            VStack {
                Spacer()
                Text("Name of new beat?").font(.largeTitle)
...
struct NewBeatNameAlert_Previews: PreviewProvider {
    static var previews: some View {
        NewBeatNameAlert(isShown: .constant(true), text: .constant("hello"))
    }
}
